...
describe('api', () => {
  ...
  describe('getValidatedOptions', () => {
    it('should throw with the right error for bad options', done => {
      const { getValidatedOptions } = HtmlRspackTagsPlugin.api;
