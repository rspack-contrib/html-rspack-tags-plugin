...
const HtmlRspackTagsPlugin = require('../');
...
describe('option validation', () => {
  it('should throw an error if no options are provided', done => {
    const theFunction = () => {
      return new HtmlRspackTagsPlugin();
    };
  ...
  it('should throw an error if the options are not an object', done => {
    const theFunction = () => {
      return new HtmlRspackTagsPlugin('hello');
    };
  ...
  describe('options.jsExtensions', () => {
    it('should throw an error if the jsExtensions is not an array or string', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: [], append: false, jsExtensions: 123 });
      };
    ...
    it('should throw an error if any of the jsExtensions are not a string', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: [], append: false, jsExtensions: ['a', 123, 'b'] });
      };
  ...
  describe('options.cssExtensions', () => {
    it('should throw an error if the cssExtensions is not an array or string', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: [], append: false, cssExtensions: 123 });
      };
    ...
    it('should throw an error if any of the cssExtensions are not a string', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: [], append: false, cssExtensions: ['a', 123, 'b'] });
      };
  ...
  describe('options.append', () => {
    it('should not throw an error if the append flag is not provided', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: [] });
      };
    ...
    it('should throw an error if the append flag is not a boolean', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: [], append: 'hello' });
      };
  ...
  describe('options.publicPath', () => {
    it('should throw an error if the publicPath option is not a boolean or string or a function', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ publicPath: 123 });
      };
    ...
    it('should throw an error if the usePublicPath flag is not a boolean', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ usePublicPath: 123 });
      };
    ...
    it('should throw an error if the addPublicPath option is not a function', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ addPublicPath: 123 });
      };
    ...
    it('should throw an error if publicPath and usePublicPath are specified together', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ publicPath: true, usePublicPath: false });
      };
    ...
    it('should throw an error if publicPath and addPublicPath are specified together', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ publicPath: true, addPublicPath: () => '' });
      };
  ...
  describe('options.hash', () => {
    it('should throw an error if the hash option is not a boolean or string or a function', done => {
      ...
      nonBooleanCheck.forEach(val => {
        const theCheck = () => {
          return new HtmlRspackTagsPlugin({ tags: [], append: true, publicPath: true, hash: val });
        };
    ...
    it('should throw an error if the hash is a number', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ hash: 123 });
      };
    ...
    it('should throw an error if the useHash flag is not a boolean', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ useHash: 123 });
      };
    ...
    it('should throw an error if the addHash option is not a function', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ addHash: 123 });
      };
    ...
    it('should throw an error if hash and useHash are specified together', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ hash: true, useHash: false });
      };
    ...
    it('should throw an error if hash and addHash are specified together', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ hash: true, addHash: () => '' });
      };
  ...
  describe('options.prependExternals', () => {
    it('should throw an error if prependExternals is not a boolean', done => {
      ...
      nonBooleanCheck.forEach(val => {
        const theCheck = () => {
          return new HtmlRspackTagsPlugin({ prependExternals: val });
        };
    ...
    it('should not throw an error if prependExternals is true', done => {
      ...
      nonStringCheck.forEach(val => {
        const theCheck = () => {
          return new HtmlRspackTagsPlugin({ prependExternals: true });
        };
    ...
    it('should not throw an error if prependExternals is false', done => {
      ...
      nonStringCheck.forEach(val => {
        const theCheck = () => {
          return new HtmlRspackTagsPlugin({ prependExternals: false });
        };
  ...
  describe('options.files', () => {
    it('should throw an error if the files option is not a string', done => {
      ...
      nonStringCheck.forEach(val => {
        const theCheck = () => {
          return new HtmlRspackTagsPlugin({ tags: [], append: true, publicPath: true, files: val });
        };
    ...
    it('should throw an error if any of the files options are not strings', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: ['foo.js', 'bar.css'], append: false, files: ['abc', true, 'def'] });
      };
  ...
  describe('options.metas', () => {
    it('should throw an error if metas is a string', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ metas: 'a string' });
      };
    ...
    it('should throw an error if metas is an object without attributes', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ metas: { path: 'abc' } });
      };
    ...
    it('should throw an error if metas is an object with non string path', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ metas: { attributes: { a: 'b' }, path: 123 } });
      };
    ...
    it('should throw an error if metas is an array containing a string', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ metas: [{ attributes: { a: 1 }, path: 'a' }, '', { attributes: { b: 2 }, path: 'b' }] });
      };
    ...
    it('should throw an error if metas is an object with empty attributes', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ metas: { attributes: { }, path: 'b' } });
      };
    ...
    it('should throw an error if metas is an array containing an object with empty attributes', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ metas: [{ attributes: { a: 1 }, path: 'a' }, { attributes: { }, path: 'b' }] });
      };
    ...
    it('should throw an error if metas has glob without path', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ metas: { attributes: { a: 1 }, glob: 'a' } });
      };
...
function runTestsForOption (optionName, isScript, runExtraTests) {
  ...
  describe(`options.${optionName}`, () => {
    it(`should throw an error if the ${optionName} are not an array or string or object`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: 123 });
      };
    ...
    it(`should throw an error if the ${optionName} contains objects and a boolean`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [{ path: `a${ext}` }, false, { path: `b${ext}` }] });
      };
    ...
    it(`should throw an error if the ${optionName} contains string and a boolean`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [`foo${ext}`, true, `bar${ext}`] });
      };
    ...
    it(`should not throw an error if the ${optionName} contains strings and objects`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [`foo${ext}`, { path: `file${ext}` }, `bar${ext}`] });
      };
  ...
  describe(`options.${optionName} path`, () => {
    it(`should throw an error if the ${optionName} contains an element that is an empty object`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [{ path: `a${ext}` }, {}, { path: `b${ext}` }] });
      };
    ...
    it(`should throw an error if the ${optionName} contains an element that is an object with a non string path`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [{ path: `a${ext}` }, { path: 123, type: 'js' }, { path: `c${ext}` }] });
      };
    ...
    it(`should not throw an error if the ${optionName} contains elements that are all objects that have a path`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [{ path: `a${ext}` }, { path: `b${ext}` }, { path: `c${ext}` }] });
      };
  ...
  describe(`options.${optionName} append`, () => {
    it(`should throw an error if the ${optionName} contains an element that is an object with a non boolean append`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [{ path: `a${ext}` }, { path: `b${ext}`, append: 123 }, { path: `c${ext}` }] });
      };
    ...
    it(`should not throw an error if the ${optionName} contains elements that are all objects that have a boolean append`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [{ path: `a${ext}`, append: true }, { path: `b${ext}`, append: false }, { path: `c${ext}`, append: true }] });
      };
  ...
  describe(`options.${optionName} publicPath`, () => {
    it(`should not throw an error if the ${optionName} contains an element that is an object with publicPath set to string`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [{ path: `a${ext}` }, { path: `b${ext}`, publicPath: 'my-public-path' }, { path: `c${ext}` }] });
      };
    ...
    it(`should throw an error if the ${optionName} contains an element that is an object with publicPath set to object`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [{ path: `a${ext}` }, { path: `b${ext}`, publicPath: {} }, { path: `c${ext}` }] });
      };
    ...
    it(`should throw an error if the ${optionName} contains an element that is an object with publicPath set to number`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [{ path: `a${ext}` }, { path: `b${ext}`, publicPath: 0 }, { path: `c${ext}` }] });
      };
    ...
    it(`should not throw an error if the ${optionName} contains an element that is an object with publicPath set to true`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [{ path: `a${ext}`, publicPath: true }, { path: `b${ext}` }, { path: `c${ext}` }] });
      };
  ...
  describe(`options.${optionName} attributes`, () => {
    it(`should throw an error if the ${optionName} contains an element that is an object with non object string attributes`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [{ path: `a${ext}` }, { path: `b${ext}`, attributes: '' }, { path: `c${ext}` }] });
      };
    ...
    it(`should throw an error if the ${optionName} contains an element that is an object with number attributes`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [{ path: `a${ext}` }, { path: `b${ext}`, attributes: 0 }, { path: `c${ext}` }] });
      };
    ...
    it(`should throw an error if the ${optionName} contains an element that is an object with boolean attributes`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [{ path: `a${ext}` }, { path: `b${ext}`, attributes: true }, { path: `c${ext}` }] });
      };
    ...
    it('should throw an error if any of the tags options are objects with an attributes property that is not an object', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: [`foo${ext}`, { path: `pathWithExtension${ext}`, attributes: 'foobar' }, `bar${ext}`] });
      };
    ...
    it('should throw an error if any of the tags options are objects with an attributes property with non string or boolean values', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: [`foo${ext}`, { path: `pathWithExtension${ext}`, attributes: { crossorigin: 'crossorigin', id: null, enabled: true } }, `bar${ext}`] });
      };
    ...
    it('should not throw an error if any of the tags options are objects with an attributes property with string or boolean values', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: [`foo${ext}`, { path: `pathWithExtension${ext}`, attributes: { crossorigin: 'crossorigin', id: 'test', enabled: true } }, `bar${ext}`] });
      };
      expect(theFunction).not.toThrowError();
      done();
    });
    ...
    it('should not throw an error if any of the tags options are objects without an attributes property', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: [`foo${ext}`, { path: `pathWithExtension${ext}` }, `bar${ext}`] });
      };
      expect(theFunction).not.toThrowError();
      done();
    });
  ...
  describe(`options.${optionName} glob`, () => {
    it(`should throw an error if any of the ${optionName} options are objects with a glob property that is not a string`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [`foo${ext}`, { path: `a${ext}`, glob: 123, type: 'js' }, `bar${ext}`] });
      };
    ...
    it(`should throw an error if any of the ${optionName} options are objects with a globPath property that is not a string`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [`foo${ext}`, { path: `a${ext}`, globPath: 123, type: 'js' }, `bar${ext}`] });
      };
    ...
    it(`should throw an error if any of the ${optionName} options are objects with a globFlatten property that is not a boolean`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [`foo${ext}`, { path: '', globPath: FIXTURES_PATH, glob: `*${ext}`, globFlatten: 123 }, `bar${ext}`] });
      };
    ...
    it(`should throw an error if any of the ${optionName} options are objects with glob specified but globPath missing`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [`foo${ext}`, { path: `pathWithExtension${ext}`, glob: 'withoutExtensions*' }, `bar${ext}`], append: false });
      };
    ...
    it(`should throw an error if any of the ${optionName} options are objects with globPath specified but glob missing`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [`foo${ext}`, { path: `pathWithExtension${ext}`, globPath: 'withoutExtensions*' }, `bar${ext}`], append: false });
      };
      expect(theFunction).toThrowError(new RegExp(`(options.${optionName} object should have a string glob property)`));
      done();
    });
    ...
    it(`should throw an error if any of the ${optionName} options are objects with glob that does not match any files`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [{ path: 'assets/', globPath: FIXTURES_PATH, glob: `nonexistant*${ext}` }], append: true });
      };
  ...
  describe(`options.${optionName} sourcePath`, () => {
    it(`should throw an error if any of the ${optionName} options are objects with an sourcePath property that is not a string`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [`foo${ext}`, { path: `a${ext}`, sourcePath: 123, type: 'js' }, `bar${ext}`] });
      };
  ...
  describe(`options.${optionName} external`, () => {
    it(`should throw an error if any of the ${optionName} options are objects with external property that is not an object`, done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ [optionName]: [`foo${ext}`, { path: `a${ext}`, external: 123 }, `bar${ext}`] });
      };
      if (isScript) {
    ...
    if (isScript) {
      it(`should not throw an error if any of the ${optionName} options are objects with valid external objects`, done => {
        const theFunction = () => {
          return new HtmlRspackTagsPlugin({ [optionName]: [`foo${ext}`, { path: `a${ext}`, external: { packageName: 'a', variableName: 'A' } }, `bar${ext}`] });
        };
        expect(theFunction).not.toThrowError();
        done();
      });
      ...
      it(`should throw an error if any of the ${optionName} options are objects with external that is an empty object`, done => {
        const theFunction = () => {
          return new HtmlRspackTagsPlugin({ [optionName]: [`foo${ext}`, { path: `a${ext}`, external: { } }, `bar${ext}`] });
        };
      ...
      it(`should throw an error if any of the ${optionName} options are objects with external that has packageName but not variableName string properties`, done => {
        const theFunction = () => {
          return new HtmlRspackTagsPlugin({ [optionName]: [`foo${ext}`, { path: `a${ext}`, external: { packageName: 'a' } }, `bar${ext}`] });
        };
      ...
      it(`should throw an error if any of the ${optionName} options are objects with external that has variableName but not packageName string properties`, done => {
        const theFunction = () => {
          return new HtmlRspackTagsPlugin({ [optionName]: [`foo${ext}`, { path: `a${ext}`, external: { variableName: 'A' } }, `bar${ext}`] });
        };
...
function runTestsForAssetType (ext) {
  describe('options.tags type', () => {
    it('should throw an error if any of the tags options are objects with an invalid type property', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: [`foo${ext}`, { path: `baz${ext}`, type: 'foo' }, `bar${ext}`], append: false });
      };
    ...
    it('should throw an error if any of the tags options do not end with .css or .js', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: ['foo.css', 'bad.txt', 'bar.js'], append: false });
      };
    ...
    it('should throw an error if any of the tags options are objects without a type property that cannot be inferred from the path', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: [`foo${ext}`, { path: 'pathWithoutExtension' }, `bar${ext}`], append: false });
      };
    ...
    it('should not throw an error if any of the tags options are objects without a type property that can be inferred from the path', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: [`foo${ext}`, { path: `pathWithExtension${ext}` }, `bar${ext}`], append: false });
      };
      expect(theFunction).not.toThrowError();
      done();
    });
    ...
    it('should not throw an error if any of the tags options are objects without a type property that can be inferred from the glob', done => {
      const theFunction = () => {
        return new HtmlRspackTagsPlugin({ tags: [`foo${ext}`, { path: '', globPath: FIXTURES_PATH, glob: `glo*${ext}` }, `bar${ext}`], append: false });
      };
      expect(theFunction).not.toThrowError();
      done();
    });
